...
var Question = React.createClass({displayName: "Question",
  ...
  render: function(){
    var answersNodes = Object.keys(this.props.data.answers).map(function(value, index){
      return (
        React.createElement("div", null, 
          ...
          React.createElement("label", {htmlFor: "answer-input-" + index}, 
    ...
    return (
      React.createElement("div", null, 
        React.createElement("h4", null, (parseInt(this.props.id) + 1) + ": " + this.props.data.question), 
        React.createElement("form", null, 
          answersNodes, 
          React.createElement("br", null), 
          React.createElement("button", {type: "button", onClick: this.props.validateAnswers}, 
              "Validate answer"
          )
        )
      )
...
var Quiz = React.createClass({displayName: "Quiz",
  ...
  renderResult: function(){
    var result = Object.keys(this.state.quiz.questions).map(function(value, index){
      if (this.isAnswerRight(value)) {
        return (
          React.createElement("div", null, "Question " + index + ": You were right!")
        )
      } else {
        return (
          React.createElement("div", null, "Question " + index + ": You were wrong!")
        )
      }
    }.bind(this));
    return (
      React.createElement("div", null, 
        ...
        React.createElement("div", null, 
          React.createElement("h3", null, "Your answers"), 
            result
        )
      )
   );
  ...
  render: function(){
    if (!this.state.quiz.questions) {return React.createElement("div", null)}
    return (
      React.createElement("div", null, 
        React.createElement("h1", null, this.state.quiz.title), 
        (this.state.step < this.state.quiz.questions.length
          ...
          : (React.createElement("div", null, this.renderResult()))
        )
      )
    )
  }
...
},{"./question.js":157,"jquery":1,"react":156}],159:[function(require,module,exports){
var Quiz = require('./components/quiz.js');
var React = require('react');

React.render(React.createElement(Quiz, null), document.getElementById('main'));

},{"./components/quiz.js":158,"react":156}]},{},[159]);
